...
<div className="messagetoast toast show" role="alert" aria-live="assertive" aria-atomic="true">
  <div className="messagetoast__header toast-header">
    ...
    data-dismiss="toast" aria-label="Close" onClick={()=>useShowDelete(false)}>
      Exit
    </button>
  </div>
  <div className="toast-body"> Are you sure you would like to leave?
  </div>
    <button className="messagetoast__delete btn btn-danger" onClick={handleRemoveuseraccountClick}>Yes please</button>
</div>
  )
}

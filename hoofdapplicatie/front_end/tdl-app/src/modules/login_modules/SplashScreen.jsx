...
import { loadCategories, loadPriorities, loadUserdata } from '../../data/general';
import { useGetAllCategoriesQuery, useGetAllPrioritiesQuery, useGetAllUserInfoQuery } from '../../data/todoApi';
...
const SplashScreen = () => {
  ...
  const {data: userData, isLoading: isLoadingUser, isError: isErrorUser, isSuccess: isSuccessUser} = useGetAllUserInfoQuery({id: userId, token});
  ...
  <h1 className="splashscreen__title">Welcome to The To Do List application</h1>
  {!loading && !error && <NavLink to="/todos" className="splashscreen__link">
    <button className="splashscreen__link__button btn btn-primary">Continue to my To Do List Application</button></NavLink>}
  </section>
